<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.*" import="redbus.model.pojo.*"%>
<!DOCTYPE HTML>
<html>
<head>
...
<body>
	<!--start-header-->
					...
					<div class="top-header">
						<div class="container">
					     <div class="top-menu">
							...
							<div class="logo">
							  <a href="index.jsp"><h1>History<span>List</span></h1></a>
						    </div>
							<!-- script-for-menu -->
								<script>
		...
		<!--start-about-->
<% 
List<Booking> ls =(List)session.getAttribute("historyList");
%>
    ...
    %>
    	 ...
    	 <tr>
             <td align="center"><% out.println(l.getBookingPnr());%></td>
             <td align="center"><%out.println (l.getBusNum());%></td>
             <td align="center"><% out.println(l.getPid());%></td>
             <td align="center"><% out.println(l.getSchId());%></td>
			 <td align="center"><% out.println(l.getSeatsBooked());%></td>
			 <td align="center"><% out.println(l.getStatus());%></td>			                         
         </tr>
          <%} %>
     </table>
</body>
