<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.*" import ="redbus.model.pojo.Passenger;"%>
					...
					<div class="top-header">
						<div class="container">
					     <div class="top-menu">
							...
							<div class="logo">
							  <a href="index.jsp"><h1>Schedule Wise<span>Passenger List</span></h1></a>
						    </div>
							<!-- script-for-menu -->
								<script>
...
<form action="./PScheduleController"  style="margin-top:80px">
<h3  class="feildstyle">Enter the Schedule ID : </h3><br>
<input type="text" name="schId" class="borderstyle" style="margin-left: 150px;"><br><br>
<input type="submit" value="Display Passenger" class="feildstyle">
</form>
