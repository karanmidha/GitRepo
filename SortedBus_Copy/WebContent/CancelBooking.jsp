...
<body>
	<!--start-header-->
					...
					<div class="top-header">
						<div class="container">
					     <div class="top-menu">
							...
							<div class="logo">
							  <a href="index.jsp"><h1>Cancel<span>Booking</span></h1></a>
						    </div>
							<!-- script-for-menu -->
								<script>
		...
		<!--//end-slider-->
		<!--start-about-->
<form action="./ModifyController" style="margin-top:80px;">

<h3 class="feildstyle">Enter The Pnr Of Ticket You Want To Cancel:</h3><br>
<input type="text" name="deletePnr" Required class="borderstyle" style="margin-left: 150px;"><br><br>
<input type="submit" value="Cancel Booking" class="feildstyle">
</form></body>
</html>