...
<!--start-header-->
					...
					<div class="top-header">
						<div class="container">
					     <div class="top-menu">
							...
							<div class="logo">
							  <a href="index.jsp"><h1>Welcome<span>Admin</span></h1></a>
						    </div>
							<!-- script-for-menu -->
								<script>
		...
		<!--start-about-->
		<br>
<div class="feildstyle" style="margin-top:50px;">
<a href="./AddBus.jsp">Add Bus</a><br><br>
<a href="./DeleteBus.jsp">Delete Bus</a><br><br>
<a href="./AdminSearchBus.jsp">Search Bus</a><br><br>
<a href="./PassengerDisplayController">View Passenger</a><br><br>
<a href="./ScheduleWisePassengerDisplay.jsp">View Schedule Wise Passenger</a><br><br>
<a href="./AddSchedule.jsp">Add Schedule</a><br><br>
