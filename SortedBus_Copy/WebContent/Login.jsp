...
<!--start-header-->
					...
					<div class="top-header">
						<div class="container">
					     <div class="top-menu">
							...
							<div class="logo">
							  <a href="index.jsp"><h1>Login<span>Page</span></h1></a>
						    </div>
							<!-- script-for-menu -->
								<script>
		...
		<!--start-about-->
		<br>
<form action="./LoginController" class="feildstyle" style="margin-top: 50px;">
<h3 >Enter Id</h3><br/>
<input type="number" name="LoginId" required class="borderstyle" class="feildstyle"><br><br>
<h3>Enter Password</h3><br/>
<input type="password" name="LoginPassword" required class="borderstyle" class="feildstyle"><br><br>
