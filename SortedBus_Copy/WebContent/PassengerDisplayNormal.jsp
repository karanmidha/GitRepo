...
<body>
	<!--start-header-->
					...
					<div class="top-header">
						<div class="container">
					     <div class="top-menu">
							...
							<div class="logo">
							  <a href="index.jsp"><h1>Passenger<span>List</span></h1></a>
						    </div>
							<!-- script-for-menu -->
								<script>
		...
		<%
    List<Passenger>list;
    list=(List)session.getAttribute("passengerSearch");
    %>
                        <h4>
    ...
    %>
         ...
         <tr>
             <td align="center"><% out.println(l.getpassengerId());%></td>
             <td align="center"><%out.println (l.getpassengerName());%></td>
             <td align="center"><% out.println(l.getpassengerAdd());%></td>
             <td align="center"><% out.println(l.getpassengerPhone());%></td>             
         </tr>
     <%} %>
     </table>
</body>
